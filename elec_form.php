...
<form class="form-horizontal" role="form" method="post" action="elechan.php">
	<div class="form-group">
		<label for="Electricity_id" class="col-sm-2 control-label">Electricity_id</label>
		<div class="col-sm-2">
			<input type="text" class="form-control" id="Electricity_id" name="Electricity_id" value="">
		</div>
	</div>
	<div class="form-group">
