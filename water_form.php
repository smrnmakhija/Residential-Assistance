...
<form class="form-horizontal" role="form" method="post" action="waterhan.php">
	<div class="form-group">
		<label for="Water_id" class="col-sm-2 control-label">Water_id</label>
		<div class="col-sm-2">
			<input type="text" class="form-control" id="Water_id" name="Water_id" value="">
		</div>
	</div>
	<div class="form-group">
